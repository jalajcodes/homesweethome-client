	...
	return (
		<Content className="host-content">
			<Form layout="vertical" onFinish={handleFormFinish} onFinishFailed={handleFormFinishFailed} >
				...
				<Item name="title" rules={[{ required: true, message: "Please enter a title for your listing!" }]} extra="Max Length of 45" label="Title">
					<Input placeholder="Luxurious 2 Bed apartment with ocaen view..." maxLength={45} />
				</Item>

				<Item name="description" rules={[{ required: true, message: "Please enter a description for your listing!" }]} label="Description of listing" extra="Max character count of 400">
					<Input.TextArea
						rows={3}
						bordered
						maxLength={400}
				...
				<Item name="city" rules={[{ required: true, message: "Please enter a city (or region) for your listing!" }]} label="City/Town">
					<Input placeholder="Los Angeles" />
				</Item>

				<Item name="state" rules={[{ required: true, message: "Please enter a state for your listing!" }]} label="State/Province">
					<Input placeholder="California" />
				</Item>

				<Item name="postalCode" rules={[{ required: true, message: "Please enter a postal code for your listing!" }]} label="Zip/Postal Code">
				...
				>
					<div className="host__form-image-upload">
						<Upload name="image" listType="picture-card" showUploadList={false} action="https://www.mocky.io/v2/5cc8019d300000980a055e76" beforeUpload={beforeImageUpload} onChange={handleImageUpload}>
							{imageBase64Value ? (
				...
				<Item name="price" rules={[{ required: true, message: "Please enter a price for your listing!" }]} label="Price" extra="Per day price of your Listing">
