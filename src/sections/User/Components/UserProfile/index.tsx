	...
	const additionalDetails = user.hasWallet ? (
		<>
			<Paragraph>
				...
				<Button loading={loading} onClick={() => disconnectStripe()} type="primary" className="user-profile__details-cta">
					Disconnect Stripe
					</Button>
				<Paragraph type="secondary">
					By Disconnecting, you won't be able to recieve <Text strong>any further payments</Text>. This will prevent other users from booking listings that you have created.
					</Paragraph>
			</Paragraph>
		</>) : (<>
