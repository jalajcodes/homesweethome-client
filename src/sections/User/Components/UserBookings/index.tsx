...
export const UserBookings = ({ userBookings, bookingsPage, setBookingsPage, limit }: Props) => {
	...
	const userBookingsList = userBookings ? (
		<List
			...
			locale={{ emptyText: "User hasn't made any bookings yet!" }}
			pagination={{
				position: 'top',
	...
	const userBookingsElement = userBookingsList ? (
		<div className="user-bookings">
			...
			<Paragraph className="user-bookings__description">
				Bookings you've made &amp; check-in and check-out dates associated with them.
			</Paragraph>
			{userBookingsList}
		</div>
	) : null;
